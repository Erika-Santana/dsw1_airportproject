...
public class LoginCommand implements Command {
	...
	/*
	 * Classe que atribui o commando encapsulado de Login. Aqui tem a lógica de
	 * autenticação do sistema. Caso for autenticado ele retorna a próxima página
	 * que o Admionistrador possui acesso "genrenciamento_voos.jsp" Caso não, ele
	 * retorna para a página inicial "index.jsp" Aqui ele também guarda alguns
	 * valores na sessão além do Login, que é a parte de error, para caso seja
